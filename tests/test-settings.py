...
vcr_path = "tests/cassettes/test-settings/test_ua_string.yaml"
...
vcr_noua_path = "tests/cassettes/test-settings/test_no_ua_string.yaml"
...
vcr_path_members = "tests/cassettes/test-settings/test_ua_string_members.yaml"
...
vcr_path_prefixes = "tests/cassettes/test-settings/test_ua_string_prefixes.yaml"
...
vcr_path_registration_agency = (
    "tests/cassettes/test-settings/test_ua_string_registration_agency.yaml"
)
