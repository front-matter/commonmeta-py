...
def test_doi_with_data_citation():
    ...
    assert subject.subjects == [
        ...
        {
            "id": "https://openalex.org/T10184",
            "subject": "Plant Molecular Biology Research",
        },
    ]
...
def test_journal_article():
    ...
    assert subject.subjects == [
        {"id": "https://openalex.org/subfields/2737", "subject": "Physiology"},
        {
            ...
            "subject": "Erythrocyte Function and Pathophysiology",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_journal_article_with_funding():
    ...
    assert subject.subjects == [
        ...
        {
            "id": "https://openalex.org/T11924",
            "subject": "Polyamine Metabolism and Applications",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_journal_article_with_rdf_for_container():
    ...
    assert subject.subjects == [
        {"id": "https://openalex.org/subfields/1911", "subject": "Paleontology"},
        {
            ...
            "subject": "Subterranean biodiversity and taxonomy",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_book_chapter_with_rdf_for_container():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "Video Surveillance and Tracking Methods",
        },
    ]
    assert subject.language == "en"
    assert subject.description is None
...
def test_posted_content():
    ...
    assert subject.subjects == [
        {"id": "https://openalex.org/subfields/1710", "subject": "Information Systems"},
        {
            ...
            "subject": "Research Data Management Practices",
        },
    ]
    assert subject.language == "en"
    assert subject.description.startswith(
...
def test_blog_post():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "Climate Change Communication and Perception",
        },
    ]
    assert subject.language == "en"
    assert subject.description.startswith(
...
def test_peer_review():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "Neural dynamics and brain function",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_doi_with_sici():
    ...
    assert subject.subjects == [
        {"id": "https://openalex.org/subfields/1311", "subject": "Genetics"},
        {
            ...
            "subject": "Evolution and Genetic Dynamics",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_doi_with_orcid():
    ...
    assert subject.subjects == [
        ...
        {
            "id": "https://openalex.org/T12744",
            "subject": "Medical Device Sterilization and Disinfection",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_vor_with_url():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "Amphibian and Reptile Biology",
        },
    ]
    assert subject.language == "en"
    assert subject.description is None
...
def test_dataset():
    ...
    assert subject.contributors == [
        ...
        {
            "type": "Person",
            "person": {"given_name": "M.F.", "family_name": "Perutz"},
            "roles": ["Author"],
        },
    ]
    assert subject.license is None
...
def test_component():
    ...
    assert subject.contributors[0] == {
        "type": "Person",
        "person": {"given_name": "Mihai G", "family_name": "Netea"},
        "roles": ["Author"],
    }
    assert subject.license == {
        "id": "CC-BY-4.0",
...
def test_book_chapter():
    ...
    assert subject.subjects == [
        {"id": "https://openalex.org/subfields/2746", "subject": "Surgery"},
        {
            ...
            "subject": "Shoulder Injury and Treatment",
        },
    ]
    assert subject.language == "en"
    assert subject.description is None
...
def test_another_book_chapter():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "Climate Change and Health Impacts",
        },
    ]
    assert subject.language == "en"
    assert subject.description is None
...
def test_yet_another_book_chapter():
    ...
    assert subject.subjects == [
        ...
        {
            "id": "https://openalex.org/T12923",
            "subject": "Digital Image Processing Techniques",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_missing_contributor():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "scientometrics and bibliometrics research",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_missing_contributor_name():
    ...
    assert (
        subject.title
        == "A computational impact analysis approach leveraging non-conforming spatial, temporal and methodological discretisations"
    )
    assert subject.contributors[0] == {
        "type": "Person",
        "person": {
...
def test_too_many_contributor_names():
    ...
    assert (
        subject.title
        == "A Hamiltonian perspective to thestabilization of systems of two conservation laws"
    )
    assert len(subject.contributors) == 3
    assert subject.contributors[0] == {
        "type": "Person",
...
def test_book():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "Chinese history and philosophy",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_proceedings_article():
    ...
    assert subject.subjects == [
        ...
        },
        {
            ...
            "subject": "Caching and Content Delivery",
        },
    ]
    assert subject.language == "en"
    assert (
...
def test_build_identifiers():
    ...
    assert identifiers[0] == {
        "identifier": "https://doi.org/10.7717/peerj.4375",
        "identifier_type": "DOI",
    }
    ...
    assert identifiers[2] == {
        "identifier": "https://pubmed.ncbi.nlm.nih.gov/29456894",
        "identifier_type": "PMID",
    }
