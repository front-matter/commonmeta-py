...
def test_doi_with_data_citation():
    ...
    assert citeproc.get('author') == [{'family': 'Sankar', 'given': 'Martial'},
...
def test_with_pages():
    ...
    assert citeproc.get('author') == [{'family': 'Thanassi', 'given': 'Wendy'}, {'family': 'Noda', 'given': 'Art'}, {'family': 'Hernandez', 'given': 'Beatriz'}, {
        'family': 'Newell', 'given': 'Jeffery'}, {'family': 'Terpeluk', 'given': 'Paul'}, {'family': 'Marder', 'given': 'David'}, {'family': 'Yesavage', 'given': 'Jerome A.'}]
...
def test_only_first_page():
    ...
    assert citeproc.get('author') == [{'family': 'Weber', 'given': 'Matthew A.'}, {
...
def test_missing_creator():
    ...
    assert citeproc.get(
        'URL') == 'https://www.mdpi.com/2304-6775/6/2/15'
    assert citeproc.get(
    ...
    assert citeproc.get('author') == [{'family': 'Kohls', 'given': 'Alexander'}, {
...
def test_organization_author():
    ...
    assert citeproc.get('author') == [{'family': 'Liu', 'given': 'Siyang'}, {'literal': 'The Genome Denmark Consortium'}, {'family': 'Huang', 'given': 'Shujia'}, {'family': 'Rao', 'given': 'Junhua'}, {
        'family': 'Ye', 'given': 'Weijian'}, {'family': 'Krogh', 'given': 'Anders'}, {'family': 'Wang', 'given': 'Jun'}]
