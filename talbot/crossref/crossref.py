...
class Crossref:
    ...
    * /works - :func:`~talbot.Crossref.works`
    * /members - :func:`~talbot.Crossref.members`
    * /prefixes - :func:`~talbot.Crossref.prefixes`
    * /funders - :func:`~talbot.Crossref.funders`
    * /journals - :func:`~talbot.Crossref.journals`
    * /types - :func:`~talbot.Crossref.types`
    * /licenses - :func:`~talbot.Crossref.licenses`

    Also:

    * registration_agency - :func:`~talbot.Crossref.registration_agency`
    * random_dois - :func:`~talbot.Crossref.random_dois`
    ...
    **The Polite Pool**
    ...
    We have been using `https` in `talbot` for a while now, so that's good
    ...
    **Setting a custom user-agent string**
    ...
    `python-requests/2.22.0 talbot/0.7.0`. We send that string with
    ...
    def works(
        ...
        **kwargs
        ...
        :param filter: Filter options. See examples for usage.
            ...
            for filter names and their descriptions and :func:`~talbot.Crossref.filter_names`
            and :func:`~talbot.Crossref.filter_details`
